...
void alege_optiunea()
{
    ...
    std::cout<<"Apasa-ti 0 pentru:Iesire program!\n";
    std::cout<<"Apasa-ti 1 pentru:Generarea programelor campionatelor(obligatoriu doar o data)!\n";
    std::cout<<"Apasa-ti 2 pentru:Simularea unei etape din fiecare campionat!\n";
    std::cout<<"Apasa-ti 3 pentru:Simularea tuturor etapelor din fiecare campionat!\n";
    std::cout<<"Apasa-ti 4 pentru:Afisarea clasamentelor din fiecare liga!\n";
    std::cout<<"Apasa-ti 5 pentru:Afisarea rezultatelor etapelor din fiecare liga!\n";
    std::cout<<"Apasa-ti 6 pentru:Afisarea numar obiecte de tip jucator!\n";
    std::cout<<"Apasa-ti 7 pentru:Afisarea loturilor echipelor pentru un anumit campionat citit de la tastatura!\n";
    std::cout<<"Apasa-ti 8 pentru:Afisarea celui mai bun jucator din fiecare echipa pentru un anumit campionat citit de la tastatura!\n";
    std::cout<<"Apasa-ti 9 pentru:Afisare numar jucatori pe o anumita pozitie din fiecare campionat!\n";
}
int main()
